"""create game_chat_reads table"""

from alembic import op
import sqlalchemy as sa
from sqlalchemy.dialects import postgresql

revision = '0040_game_chat_reads'
down_revision = '0039_game_chat_msg_detections'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index('ix_game_chat_reads_chat_id', 'game_chat_reads', ['chat_id'], unique=False)
    op.create_index('ix_game_chat_reads_user_id', 'game_chat_reads', ['user_id'], unique=False)

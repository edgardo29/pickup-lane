"""Policy acceptance admin scaffold workflows."""
...
def get_policy_acceptance_or_404(
    db: Session,
...
def create_policy_acceptance_record(
    db: Session,
...
def get_policy_acceptance_record(
    db: Session,
    policy_acceptance_id: uuid.UUID,
) -> PolicyAcceptance:
    return get_policy_acceptance_or_404(db, policy_acceptance_id)


def list_policy_acceptance_records(
    db: Session,
    *,
...
def update_policy_acceptance_record(
    db: Session,
    policy_acceptance_id: uuid.UUID,
    policy_acceptance_update: PolicyAcceptanceUpdate,
) -> PolicyAcceptance:
    db_policy_acceptance = get_policy_acceptance_or_404(db, policy_acceptance_id)

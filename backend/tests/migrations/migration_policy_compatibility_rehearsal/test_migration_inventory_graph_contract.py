...
_EXPECTED_CURRENT_REVISION_COUNT = 59
_EXPECTED_CURRENT_BASE = "0001_pg_trgm"
_EXPECTED_CURRENT_HEAD = "0059_admin_review_case_events"
...
def test_current_alembic_revision_chain_is_linear_and_complete() -> None:
    ...
    assert revisions[-1].path.name == "0059_create_admin_review_case_events_table.py"
    ...
    assert alembic_parent_revision(_EXPECTED_CURRENT_HEAD) == "0058_admin_review_signals"

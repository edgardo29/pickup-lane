...
def add_checkout_booking_status_history(
    db: Session,
    booking: Booking,
    *,
...
def add_checkout_participant_status_history(
    db: Session,
...
def confirm_credit_covered_checkout(
    ...
    *,
    ...
    for index, participant in enumerate(participants):
        ...
        participant.updated_at = now
        db.add(participant)
        add_checkout_participant_status_history(
            db,
            participant,
            old_participant_status=old_participant_status,
            old_attendance_status=old_attendance_status,
    ...
    booking.updated_at = now
    db.add(booking)
    add_checkout_booking_status_history(
        db,
        booking,
        old_booking_status=old_booking_status,
        old_payment_status=old_payment_status,

...
down_revision = '0043_participant_status_history'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index('ix_payment_events_payment_id_created_at', 'payment_events', ['payment_id', 'created_at'], unique=False)
    op.create_index('ix_payment_events_processing_status', 'payment_events', ['processing_status'], unique=False)
    op.create_index('ix_payment_events_processing_status_created_at', 'payment_events', ['processing_status', 'created_at'], unique=False)

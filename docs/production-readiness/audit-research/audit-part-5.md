...
|---|---|---|
| Authentication | docs/agent-notes/feature-notes/auth.md describes product behavior, but no named owner | Owner decision missing |
| Authorization | docs/agent-notes/feature-notes/admin/phase-1-foundation/access.md and permissions docs describe behavior, but no named owner | Owner decision missing |
| Payments | README.md:16 and payment docs describe Stripe use, but no named owner | Owner decision missing |
| Database | docs/agent-notes/coding-standards/database.md:3-12 describes schema ownership rules, not production owner | Owner decision missing |

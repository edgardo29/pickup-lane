...
| `WS09-03` | Metrics, alerts and capacity | Approved two-child decomposition. `WS09-03A` is accepted through merged PR #185. Mandatory `WS09-03B` remains deferred until its final provider, topology, access, retention, workload, threshold, and safe-runtime trigger is satisfied. Parent `WS09-03` remains incomplete. |
...
| `WS09-03A` | `WS09-03` | `passes/ws09/ws09-03a-provider-independent-critical-metrics-and-scanner-latency-correction.md` | Accepted through merged PR #185 |
...
Original parent: `WS05-03 - Refunds, credits, notices and reconciliation`.
...
1. `WS05-03A - Refund, credit, compensation, and financial-notice fulfillment`
2. `WS05-03B - Bounded periodic monetary reconciliation`
...
`WS09-03A` is accepted through merged PR #185. It owns the bounded provider-independent

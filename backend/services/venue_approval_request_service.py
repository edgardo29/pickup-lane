"""Venue approval request scaffold workflow helpers."""
...
def get_venue_approval_request_record(
    db: Session,
...
def create_venue_approval_request_record(
    db: Session,
...
def list_venue_approval_request_records(
    db: Session,
    *,
...
def update_venue_approval_request_record(
    db: Session,
    venue_approval_request_id: uuid.UUID,
    venue_approval_request_update: VenueApprovalRequestUpdate,
) -> VenueApprovalRequest:
    db_venue_approval_request = get_venue_approval_request_record(
        db,
        venue_approval_request_id,
    )

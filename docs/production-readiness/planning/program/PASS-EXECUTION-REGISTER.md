...
| `WS09-02` | Administrative auditability | Not implemented. Corrected scope is governed by master section 8.7; Stage 0 determines whether the unit executes whole or requires decomposition; do not decompose unless genuinely needed. |

"""create platform_notice_selected_reads table"""

from alembic import op
import sqlalchemy as sa
from sqlalchemy.dialects import postgresql

revision = '0015_platform_selected_reads'
down_revision = '0014_platform_notice_recipients'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index('ix_platform_notice_selected_reads_user_notice', 'platform_notice_selected_reads', ['user_id', 'notice_id'], unique=False)

    ...
    "money": frozenset(
        {
            ...
            "host_publish_fee_id",
            "manual_review_financial_outcome_id",
...
TARGET_MODEL_BY_FIELD = {
    ...
    TARGET_PLATFORM_NOTICE_ID: PlatformNotice,
...
TARGET_NOT_FOUND_DETAIL = {
    ...
    TARGET_PLATFORM_NOTICE_ID: "Target platform notice not found.",

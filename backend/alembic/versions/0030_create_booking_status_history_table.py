...
def upgrade() -> None:
    op.create_table(
        ...
        sa.CheckConstraint("new_booking_status IN ('pending_payment', 'confirmed', 'waitlisted', 'partially_cancelled', 'cancelled', 'expired', 'failed')", name='ck_booking_status_history_new_booking_status'),
        ...
        sa.CheckConstraint("(old_booking_status IS NULL OR old_booking_status IN ('pending_payment', 'confirmed', 'waitlisted', 'partially_cancelled', 'cancelled', 'expired', 'failed'))", name='ck_booking_status_history_old_booking_status'),

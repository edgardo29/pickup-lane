"""Host publish fee scaffold and current-host read workflows."""
...
def create_host_publish_fee_record(
    db: Session,
...
def list_current_host_publish_fee_records(
    db: Session,
    *,
    current_user: User,
) -> list[HostPublishFee]:
...
def update_host_publish_fee_record(
    ...
    db_host_publish_fee = get_host_publish_fee_or_404(db, host_publish_fee_id)

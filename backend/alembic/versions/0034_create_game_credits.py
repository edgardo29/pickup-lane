...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "((usage_type = 'redeem' AND usage_status IN ('reserved', 'redeemed', 'released')) OR (usage_type = 'reverse' AND usage_status = 'reversed') OR (usage_type = 'restore' AND usage_status = 'restored'))",
    ...
    op.create_index("ix_game_credit_usage_payment_id", "game_credit_usage", ["payment_id"])
    op.create_index("ix_game_credit_usage_usage_status", "game_credit_usage", ["usage_status"])
...
def downgrade() -> None:
    ...
    op.drop_index("ix_game_credit_usage_usage_status", table_name="game_credit_usage", if_exists=True)
    op.drop_index("ix_game_credit_usage_payment_id", table_name="game_credit_usage", if_exists=True)
    op.drop_index("ix_game_credit_usage_game_credit_id", table_name="game_credit_usage")
    op.drop_index("ix_game_credit_usage_game_id", table_name="game_credit_usage", if_exists=True)

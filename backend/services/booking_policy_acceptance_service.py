"""Booking policy acceptance admin scaffold workflows."""
...
def get_booking_policy_acceptance_or_404(
    db: Session,
...
def create_booking_policy_acceptance_record(
    db: Session,
...
def get_booking_policy_acceptance_record(
    db: Session,
    booking_policy_acceptance_id: uuid.UUID,
) -> BookingPolicyAcceptance:
    return get_booking_policy_acceptance_or_404(db, booking_policy_acceptance_id)


def list_booking_policy_acceptance_records(
    db: Session,
    *,
...
def update_booking_policy_acceptance_record(
    db: Session,
    booking_policy_acceptance_id: uuid.UUID,
    booking_policy_acceptance_update: BookingPolicyAcceptanceUpdate,
) -> BookingPolicyAcceptance:
    db_booking_policy_acceptance = get_booking_policy_acceptance_or_404(
        db,
        booking_policy_acceptance_id,
    )
